...
* [Starling](https://gamua.com/starling/) - High-performance 2D graphics engine built on Stage3D. API identical to Flash API. ([github](https://github.com/Gamua/Starling-Framework) ⭐ 3,103 | 🐛 97 | 🌐 ActionScript | 📅 2026-07-17, [help](http://wiki.starling-framework.org/start)).
...
* [GPUI](https://github.com/inspirit/GPUI) ⭐ 73 | 🐛 2 | 🌐 ActionScript | 📅 2012-05-03 - Tiny GUI Library based on Stage3D (GPU).
...
* [Gamepad](https://github.com/iainlobb/Gamepad) ⭐ 57 | 🐛 3 | 🌐 ActionScript | 📅 2017-02-05 - Simulates an analog joystick input using the keyboard.
...
* [Zxing AS3](https://github.com/zxing/zxing/tree/c1df162b95e07928afbd4830798cc1408af1ac67/actionscript) ⭐ 34,090 | 🐛 3 | 🌐 Java | 📅 2026-09-07 - QR code detection and generation ([docs](https://zxing.github.io/zxing/)).
...
* [Actionscript-oauth2](https://github.com/charlesbihis/actionscript-oauth2) ⭐ 110 | 🐛 2 | 🌐 ActionScript | 📅 2022-03-17 - Interfacing with OAuth 2.0 services.
